...
num_parents_mating = 10 # 交配池大小
sol_per_pop = 20 # 种群大小
num_genes = len(set_cen) # 染色体基因位点数量
gene_space = [0, 1] # 基因取值范围

parent_selection_type = "sss" # 选择算子形式
crossover_type = "scattered" # 交叉形式，离散即uniform
mutation_type = "random" # 变异模式，随机
mutation_percent_genes = 5 # 变异率0.05
keep_parents=-1 # 默认值，保留全部父母
...
print("********************")
print(len(set_stad)/len(set_cen))
print("********************")
